        ...
        <div className="Reset-margin Header-app">
          <div className="Full-width Header-background-first">
            <Row className="Center Header-one">
                ...
                <Link to="/login" style={whiteColorText} >Đăng nhập</Link>
                <Link to="/signup" style={whiteColorText} >Đăng kí</Link>
                <Link to="/profile" style={whiteColorText} >Thông tin cá nhân </Link>
            </Row>
          </div>
          <Row className="Full-width Header-background-Second">
            <div className="Max-width Full-width">
              <Col xs={12} sm={4} md={4} lg={2}>
                <img className="Logo-Beego" src={require("../../assets/image/beego.png")}
                />
              </Col>
              <Col className="Flex-align-center" xs={12} sm={6} md={6} lg={8}>
                <form className="Full-width Form-input">
                  ...
                  />
                  <Button
                    className="Height-control Button-search"
                  >
                    <i className="fas fa-search"></i>
                  </Button>
                  <Button
                    className="Height-control Your-cart"
                  >
